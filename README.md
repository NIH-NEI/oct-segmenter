...
- `oct-segmenter/dist/oct_segmenter-0.8.4-py2.py3-none-any.whl`
- `oct-image-segmentation-models-mod/dist/oct_image_segmentation_models-0.8.4-py2.py3-none-any.whl`
...
pip install \
    --trusted-host pypi.org \
    --trusted-host files.pythonhosted.org \
    ./dist/oct_segmenter-0.8.4-py3-none-any.whl
```
