    ...
    for subdir, dirs, files in os.walk(input_dir):
        for file in files:
            if file.endswith(".tiff") or file.endswith(".TIFF"):
                ...
                img_name_left, img_array_left, seg_map_left, segs_left, img_name_right, img_array_right, seg_map_right, segs_right = preprocess.process_image(image_file, output_dir, save_file)
