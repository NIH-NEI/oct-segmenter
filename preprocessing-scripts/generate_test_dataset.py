...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print(
            "Usage: python3 generate_training_dataset.py <path/to/training/input/dir> <output_file_name>"
        )
        exit(1)
    ...
    test_dataset: h5py.File = generate_test_dataset(
        test_input_dir, output_file, wayne_format=True
    )
    test_dataset.close()
