function comp_exp(path)
    %
    % Applies 'compensation' and 'exponentiation' to the TIFF file
    ...
    I = double(I);
    I = (I/255).^4;
    I = (I./ (flipud(cumtrapz(flipud(I))))).^2; % K (Equation A7 - Appendix)
    I = nthroot(I, 4)*255;
    I = uint8(I);
    imwrite(I, path(1:end-5) + "_comp_exp.tiff")
end